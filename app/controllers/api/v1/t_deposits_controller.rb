class Api::V1::TDepositsController < Api::BaseController
	...
	def create
	    ...
	    user: current_user, price: params[:price] , currency: @currency ,
	    payment_service: @payment_service , country: @country,transaction_id: params[:transaction_id],
	    operator: params[:operator], type: params[:type])
